...
public class QuizSettingsActivity extends QuizActivity {
    ...
    private void saveAvatar(Bitmap avatar) {
        ...
        String strAvatarUri = mGameSettings.getString(GAME_PREFERENCES_AVATAR, "android.resource://com.androidbook.triviaquiz18/drawable/avatar");
    ...
    /**
     * Attempt to get the last known location of the device. Usually this is the last value that a location provider set
     */
    ...
    private class ImageUploadTask extends AsyncTask<Object, String, Boolean> {
        ...
        protected Boolean doInBackground(Object... params) {
            // an example using HttpClient and HttpMime to upload a file via HTTP POST in the same
