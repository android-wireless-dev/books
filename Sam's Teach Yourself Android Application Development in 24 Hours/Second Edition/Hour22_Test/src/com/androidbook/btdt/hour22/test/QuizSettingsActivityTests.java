package com.androidbook.btdt.hour22.test;
...
import com.androidbook.btdt.hour22.QuizActivity;
import com.androidbook.btdt.hour22.QuizSettingsActivity;
import com.androidbook.btdt.hour22.R;

public class QuizSettingsActivityTests extends
		ActivityInstrumentationTestCase2<QuizSettingsActivity> {
	private static final String DEBUG_TAG = "QuizSettingsActivityTests";
	private static final String TESTNICK_KEY_PRESSES = "T E S T N I C K BACK";
	...
	protected void setUp() throws Exception {
		...
		nickname = (EditText) settingsActivity
