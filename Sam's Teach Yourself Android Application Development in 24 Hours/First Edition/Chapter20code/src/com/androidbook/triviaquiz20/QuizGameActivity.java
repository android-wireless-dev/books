package com.androidbook.triviaquiz20;
...
public class QuizGameActivity extends QuizActivity {
    ...
    /**
     * Helper method to configure the question screen when no questions were found. Could be called for a variety of error cases, including no new questions, IO failures, or parser failures.
     */
    ...
    private class QuizTask extends AsyncTask<Object, String, Boolean> {
        ...
        protected Boolean doInBackground(Object... params) {
            ...
            try {
                // must put paramters in correct order and correct type, otherwise a ClassCastException will be thrown
        ...
        /**
         * Parses the XML questions to {@see mQuestions}. They're preloaded into an XmlPullParser (questionBatch)
         * 
         * @param questionBatch
        ...
        private boolean loadQuestionBatch(int startQuestionNumber, String xmlSource) {
            ...
            // Contact the server and retrieve a batch of question data, beginning at startQuestionNumber
