...
public class SimpleNotificationsActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // create this outside the button so we can increment the number drawn
        // over the icon
        final Notification notify = new Notification(R.drawable.ic_stat_notify,
                "Hello!", System.currentTimeMillis());
        notify.icon = R.drawable.ic_stat_notify;
        ...
        notify2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Notification notify = new Notification(
                        android.R.drawable.stat_notify_chat, "Vibrate!", System
                                .currentTimeMillis());
                notify.flags |= Notification.FLAG_AUTO_CANCEL;
                ...
                PendingIntent intentBack = PendingIntent.getActivity(
                        SimpleNotificationsActivity.this, 0, toLaunch, 0);
                notify.setLatestEventInfo(SimpleNotificationsActivity.this,
                        "Bzzt!", "This vibrated your phone.", intentBack);
        ...
        notify3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                PendingIntent intentBack = PendingIntent.getActivity(
                        SimpleNotificationsActivity.this, 0, toLaunch, 0);
                notify.setLatestEventInfo(SimpleNotificationsActivity.this,
                        "Bright!", "This lit up your phone.", intentBack);
        ...
        notify4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                notify.sound = Uri
                        .parse("android.resource://com.androidbook.simplenotifications/"
                                + R.raw.fallbackring);
                Intent toLaunch = new Intent(SimpleNotificationsActivity.this,
                        SimpleNotificationsActivity.class);
                PendingIntent intentBack = PendingIntent.getActivity(
                        SimpleNotificationsActivity.this, 0, toLaunch, 0);
                notify.setLatestEventInfo(SimpleNotificationsActivity.this,
                        "Wow!", "This made your phone noisy.", intentBack);
    ...
    public void onNewNotify1(View view) {
            ...
            Notification notify = new Notification.Builder(this)
                    ...
                    .setContentIntent(
                            PendingIntent.getActivity(
                                    SimpleNotificationsActivity.this, 0,
                                    toLaunch, 0))
                    .setContentText("Hello from down here!").getNotification();
            notifier.notify(NOTIFY_6, notify);
        } else {
            Toast.makeText(this, "Only on API Level 11 or later.",
