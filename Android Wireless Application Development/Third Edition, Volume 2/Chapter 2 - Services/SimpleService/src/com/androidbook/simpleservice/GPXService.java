...
public class GPXService extends Service {
    ...
    private void doServiceStart(Intent intent, int startId) {
        ...
        Notification notify =
            new Notification(android.R.drawable.stat_notify_more, "GPS Tracking",
        ...
        notify.setLatestEventInfo(getApplicationContext(), "GPS Tracking",
            "Tracking start at " + updateRate + "ms intervals with [" + best
    ...
    private LocationListener trackListener = new LocationListener() {
        public void onLocationChanged(Location location) {
            ...
            lastTime = thisTime;
            String locInfo =
                String.format("Current loc = (%f, %f) @ (%.1f meters up)",
            ...
            if (lastLocation != null) {
                ...
                if (location.hasSpeed()) {
                    ...
                    locInfo +=
                        String.format(" (or %.1fm/s)", lastSpeed, gpsSpeed);
                } else {
                }
            }
