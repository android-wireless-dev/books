...
public class SensorsActivity extends Activity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        // do as little as possible here; offload work to another thread if needed; don't block
    ...
    private void handleStartSensor(TextView status, Button start, Button stop, int checkedId) {
        ...
        if (defaultSensor != null) {
            isAvailable = sensors.registerListener(SensorsActivity.this, defaultSensor, SensorManager.SENSOR_DELAY_NORMAL);
        }
        if (!isAvailable) {
