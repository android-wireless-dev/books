...
public class DrawTextActivity extends DrawingActivity {
    ...
    private static class ViewWithText extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText("Default Typeface (Normal)", 30, currentLinePosition, mPaint);
            ...
            canvas.drawText("Sans Serif Typeface (Normal)", 30, currentLinePosition, mPaint);

            mType = Typeface.create(Typeface.SANS_SERIF, Typeface.BOLD);
            mPaint.setTypeface(mType);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Sans Serif Typeface (Bold)", 30, currentLinePosition, mPaint);

            mType = Typeface.create(Typeface.MONOSPACE, Typeface.NORMAL);
            mPaint.setTypeface(mType);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Monospace Typeface (Normal)", 30, currentLinePosition, mPaint);

            mType = Typeface.create(Typeface.SERIF, Typeface.NORMAL);
            mPaint.setTypeface(mType);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Serif Typeface (Normal)", 30, currentLinePosition, mPaint);

            mType = Typeface.create(Typeface.SERIF, Typeface.BOLD);
            mPaint.setTypeface(mType);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Serif Typeface (Bold)", 30, currentLinePosition, mPaint);

            mType = Typeface.create(Typeface.SERIF, Typeface.ITALIC);
            mPaint.setTypeface(mType);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Serif Typeface (Italic)", 30, currentLinePosition, mPaint);

            mType = Typeface.create(Typeface.SERIF, Typeface.BOLD_ITALIC);
            mPaint.setTypeface(mType);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Serif Typeface (Bold Italic)", 30, currentLinePosition, mPaint);

            mPaint.setTypeface(null);
            mPaint.setTextSize(sizeB);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Text Size " + sizeB, 30, currentLinePosition, mPaint);

            mPaint.setTextSize(sizeD);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Text Size "+sizeD, 30, currentLinePosition, mPaint);

            mPaint.setTextSize(sizeC);
            mPaint.setAntiAlias(false);
            currentLinePosition += mPaint.getFontSpacing();
            canvas.drawText("Text Not Anti-Aliased", 30, currentLinePosition, mPaint);
