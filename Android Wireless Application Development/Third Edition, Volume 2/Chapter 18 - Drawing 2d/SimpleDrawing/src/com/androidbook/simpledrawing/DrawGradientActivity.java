...
public class DrawGradientActivity extends DrawingActivity {
    ...
    private static class ViewWithGradient extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            LinearGradient linGrad = new LinearGradient(0, 0, scale(25),
            ...
            RadialGradient radGrad = new RadialGradient(scale(250), scale(175),
            ...
            SweepGradient sweepGrad = new SweepGradient(canvas.getWidth()
