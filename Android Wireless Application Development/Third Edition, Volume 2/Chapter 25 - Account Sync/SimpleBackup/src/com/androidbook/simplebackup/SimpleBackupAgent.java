package com.androidbook.simplebackup;
...
public class SimpleBackupAgent extends BackupAgentHelper {
	...
	private static final String PREFERENCE_FILENAME = "AppPrefs";	// Same as Activity class
	private static final String APP_FILE_NAME = "appfile.txt";		// Same as Activity class
	
	static final String BACKUP_PREFERENCE_KEY = "BackupAppPrefs";	// Keys to uniquely identify backup data
    static final String BACKUP_FILE_KEY = "BackupFile";

	@Override
	public void onCreate() {

		SharedPreferencesBackupHelper prefshelper = new SharedPreferencesBackupHelper(this, PREFERENCE_FILENAME);
