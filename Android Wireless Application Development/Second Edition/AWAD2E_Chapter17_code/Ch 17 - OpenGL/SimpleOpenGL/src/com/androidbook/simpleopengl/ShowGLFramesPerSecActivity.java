...
public class ShowGLFramesPerSecActivity extends Activity {
    ...
    private class BasicGLThread extends Thread {
        private static final String DEBUG_TAG =
            "ShowGLFramesPerSecActivity$BasicGLThread";
        SurfaceView sv;
        ...
        public void initGL() {
            ...
            mGL.glLightfv(GL10.GL_LIGHT0, GL10.GL_DIFFUSE, new float[] { 1f, 1f,
                1f, 1f }, 0);
        ...
        public void initEGL() throws Exception {
            mEGL =
                (EGL10) GLDebugHelper.wrap(EGLContext.getEGL(),
            ...
            mGLConfig = configs[0];
            mGLSurface =
                mEGL.eglCreateWindowSurface(mGLDisplay, mGLConfig,
                    sv.getHolder(), null);
            if (mGLSurface == null) {
                throw new Exception("Couldn't create new surface");
            }
            mGLContext =
                mEGL.eglCreateContext(mGLDisplay, mGLConfig,
            ...
            mGL =
                (GL10) GLDebugHelper.wrap(mGLContext.getGL(),
                    GLDebugHelper.CONFIG_CHECK_GL_ERROR
